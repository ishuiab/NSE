	...
	<div id="page-content-wrapper">
		<div class="panel panel-gray" style='width:99%;'>
			...
			<table style='width:30%;vertical-align:middle;' class='table table-bordered'>
					<tr>
						<th style='font-size:10px;text-align:center;font-weight: bold;'>Year</th>
					...
					<?php
							get_max_year();
					?>
						<td><center><button  type="button" style='font-size:10px'class="btn btn-warning .btn-sm" onclick="call_back('get_anon_div','year','anon_div');">Search</button></center></td>
					</tr>
			</table>
		</center>
		<center>

...
<body>
	<div id="page-content-wrapper">
		<div class="panel panel-gray" style='width:99%;'>
            ...
            <center>
					<br>
			<table style='width:80%;vertical-align:middle;' class='table table-bordered'>
					<tr>
						<th colspan='3'>
					...
					<tr class='danger'>
						<td colspan='4'>
							<center>
								<button type="button" style="font-size:12px;" class="btn btn-warning .btn-sm" onclick="search()">Get Stock</button>
							</center>
						</td>
					</tr>
			</table>
